...
public class SwUtil {
    ...
    public static boolean checkHourStr(String timeStr) {
        try {
            org.nott.simpledrop.global.Formatter.DATE.HH_MM.parse(timeStr);
    ...
    public static boolean hourIsBefore(String time1, String time2) {
        ...
        Date hour2 = null;
        try {
            hour1 = org.nott.simpledrop.global.Formatter.DATE.HH_MM.parse(time1);
            hour2 = org.nott.simpledrop.global.Formatter.DATE.HH_MM.parse(time2);
        } catch (ParseException e) {
            throw new RuntimeException(e);
        }
